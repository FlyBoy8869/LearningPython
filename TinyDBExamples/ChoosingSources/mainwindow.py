...
import messages
from manage_sources import ManageSourcesDialog
...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def handle_manage_sources(self, _) -> None:
        ManageSourcesDialog(self).exec()
    ...
    def add_menu_actions(self) -> None:
        ...
        # )
        # sources_menu.addAction("Manage Sources...").triggered.connect(
        #     self.handle_manage_sources,
        # )
        self.menuSettings.addAction("Manage Sources...").triggered.connect(
            self.handle_manage_sources,
        )
